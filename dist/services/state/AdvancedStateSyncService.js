...
exports.AdvancedStateSyncService = void 0;
const DistributedStateManager_1 = require("./DistributedStateManager");
const events_1 = require("events");
class AdvancedStateSyncService extends events_1.EventEmitter {
    constructor(config) {
        super();
    ...
    // 设置事件处理器
    setupEventHandlers() {
        this.stateManager.on('stateUpdate', (update) => {
            this.emit('stateUpdate', update);
            this.replicateUpdate(update);
        });
        this.stateManager.on('remoteStateUpdate', (update) => {
            this.emit('remoteStateUpdate', update);
        });
        this.stateManager.on('nodeRegistered', (nodeInfo) => {
            this.emit('nodeRegistered', nodeInfo);
        });
        this.stateManager.on('nodeUnregistered', (nodeId) => {
    ...
    // 选择复制目标节点
    selectReplicationTargets(update) {
...
exports.AdvancedStateSyncService = AdvancedStateSyncService;
//# sourceMappingURL=AdvancedStateSyncService.js.map